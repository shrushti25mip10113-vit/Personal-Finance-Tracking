...
You can manually test the program by: 
1. Testing Menu Navigation-Run the script and confirm that all menu options appear correctly.
2. Adding Transactions-Add income with positive, zero, or invalid (letters, symbols) inputs , Add expenses the same way as of income, Confirm that the program handles unexpected values gracefully.
3. Viewing Summary-Ensure totals update correctly after each transaction.
4. Exiting the Program-Check the system exits cleanly after selecting option 4.
